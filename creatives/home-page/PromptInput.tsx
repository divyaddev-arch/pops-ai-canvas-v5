...
import { TextField, IconButton, Icon } from '@my-google-project/gm3-react-components';
    ...
    <div className="w-full max-w-[830px] p-0.5 rounded-2xl bg-gradient-to-br from-[#4285F4] via-[#9B72CB] to-[#D96570] shadow-[0_4px_4px_rgba(0,0,0,0.25)] font-google-sans-text" id={id}>
      <div className="relative bg-[#F0F4F9] rounded-[15px] p-6 flex flex-col min-h-[174px]" id={`${id}-inner`}>
        <TextField
          ...
          inputClassName="bg-transparent border-none focus:ring-0 p-0 text-base text-[#444746] placeholder:text-[#444746] h-full resize-none font-google-sans-text"
          id="prompt-input-text-field-1"/>
        <div className="flex justify-end items-center mt-4 space-x-1" id="prompt-input-div-3">
          <IconButton id="prompt-input-icon-button-1">
            <Icon className="material-symbols-outlined">add_photo_alternate</Icon>
          </IconButton>
          <IconButton id="prompt-input-icon-button-2">
        ...
        <div className="absolute top-3 right-3" id="prompt-input-div-4">
          <IconButton id="prompt-input-icon-button-4">
            <Icon className="material-symbols-outlined">collapse_content</Icon>
          </IconButton>
        </div>
      </div>
    </div>
