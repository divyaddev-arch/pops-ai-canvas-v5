...
import { Button, Icon, Chip, Snackbar, TextField, IconButton } from './GM3';

export { Button, Icon, Chip, Snackbar, TextField, IconButton };
...
const Page01 = () => {
  ...
  return (
    <div className="flex flex-col h-screen w-full bg-surface text-on-surface overflow-hidden font-google-sans-text relative" id="page01-root-container">
      <div className="h-16 bg-surface text-on-surface flex items-center justify-between px-6 relative z-50">
      ...
      <div className="flex flex-1 overflow-hidden relative z-10">
        <aside className="w-[256px] h-full bg-[#F8FAFD] flex flex-col p-0 gap-0 overflow-y-auto shrink-0" id="custom-sidebar">
          <div className="p-2 pt-2 flex flex-col gap-4">
            {/* Extended FAB */}
            <div className="pl-2 pr-0 pt-2 pb-0">
              <Button
                variant="filled"
                className="!w-fit min-w-[173px] px-6 !h-[56px] !rounded-2xl !bg-[#D3E3FD] !text-[#0842A0] !normal-case flex items-center justify-center gap-2 shadow-none font-google-sans font-medium"
                onClick={handleClearChat}
              >
                <Icon className="text-[#0842A0] material-symbols-outlined">add</Icon>
                <span className="text-base whitespace-nowrap">Create project</span>
              </Button>
            </div>
